"""
qvex/strategies/adaptive_ensemble.py
========================================
...
class AdaptiveStrategyEnsemble:
    ...
    def _init_strategies(self):
        from qvex.strategies.stat_arb           import KalmanStatArbStrategy
        from qvex.strategies.mean_reversion     import MeanReversionStrategy
        from qvex.strategies.trend_following    import TrendFollowingStrategy
        from qvex.strategies.vwap_reversion     import VWAPReversionStrategy
        from qvex.strategies.opening_range_breakout import OpeningRangeBreakoutStrategy
        from qvex.strategies.order_flow_momentum    import OrderFlowMomentumStrategy
        from qvex.strategies.volatility_breakout    import VolatilityBreakoutStrategy
        from qvex.strategies.rsi_divergence         import RSIDivergenceStrategy
